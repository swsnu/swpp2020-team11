...
def setup_suggest_database(user):
    ...
    tag1 = HashTag.objects.create(hashtag_name="first", feature=None, count=0)
    tag1.save()
    tag2 = HashTag.objects.create(hashtag_name="second", feature=None, count=0)
    tag2.save()
    tag3 = HashTag.objects.create(hashtag_name="third", feature=None, count=0)
    tag3.save()
